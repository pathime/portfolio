...
export var PROJECTS: Project[] = [
    {
        ...
        github: 'http://github.com/pathime/granangular',
        slug: 'granular'
    },
    {
        name: 'Tingaling',
